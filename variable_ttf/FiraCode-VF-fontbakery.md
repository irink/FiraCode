...
* :zzz: **SKIP** Font family at 'variable_ttf' lacks a METADATA.pb file.
...
<details>
<summary><b>[117] FiraCode-VF.ttf</b></summary>
<details>
<summary>:fire: <b>FAIL:</b> Substitute copyright, registered and trademark symbols in name table entries.</summary>

* [com.google.fonts/check/019](https://github.com/googlefonts/fontbakery/search?q=com.google.fonts/check/019)
* :fire: **FAIL** NAMEID #0 contains symbol that should be replaced by '(c)'.
...
* :information_source: **INFO** Bad string at [nameID 0, 'utf_16_be']: 'b'Copyright &#169; 2015 by Nikita Prokopov''
...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 1050, but got 935 instead [code: ascent]
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 500, but got 265 instead [code: descent]
...
* :fire: **FAIL** Found an variable font instance with 'wght'=450.0. This should instead be a multiple of 100.
...
<details>
<summary>:fire: <b>FAIL:</b> Checking correctness of monospaced metadata.</summary>
...
* :warning: **WARN** Font is monospaced but 29 glyphs (1.745936183022276%) have a different width. You should check the widths of: ['p', 'uni0440', 'uni200B', 'uniFEFF', 'uni0308', 'uni0307', 'gravecomb', 'acutecomb', 'uni030B', 'uni0302', 'uni030C', 'uni0306', 'uni030A', 'tildecomb', 'uni0304', 'uni0305', 'uni030F', 'uni0313', 'uni0314', 'uni0326', 'uni0327', 'uni0342', 'uni0345', 'LIG', 'null', '_part.numbersign', 'uniE000', 'uniE001', 'uniE002'] [code: mono-outliers]
...
* :warning: **WARN** OS/2 VendorID value 'CTDB' is not a known registered id. You should set it to your own 4 character code, and register that code with Microsoft at https://www.microsoft.com/typography/links/vendorlist.aspx [code: unknown]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Fira Code Light' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 1.206']
...
* :information_source: **INFO** Version string is: "Version 1.206"
...
* :bread: **PASS** variable_ttf/FiraCode-VF.ttf is named canonically.
